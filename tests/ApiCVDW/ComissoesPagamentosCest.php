...
class ComissoesPagamentosCest extends Common
{
    public function getComissoesPagamentos(ApiTester $i)
    {
        sleep(3);
        $startTime = time();
        ...
        $i->sendGet('/comissoes/pagamentos', $bodyContent);
        sleep(3);
        $endTime = time();
    ...
    public function getComissoesPagamentosComDataReferencia(ApiTester $i)
    {
