...
class AssistenciasItensWorkflowTempoCest extends Common
{
    public function getAssistenciasItensWorkflowTempo(ApiTester $i)
    {
        ...
        $i->sendGet('/assistencias/itens/workflow/tempo', $bodyContent);
        sleep(3);
        $endTime = time();
    ...
    public function getAssistenciasItensWorkflowTempoComDataReferencia(ApiTester $i)
    {
