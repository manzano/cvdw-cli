...
class CampanhasAtivacaoCest extends Common
{
    ...
    public function getCampanhasAtivacao(ApiTester $i)
    {
        ...
        $i->sendGet('/campanhas_ativacao', $getContent);
    ...
    public function getCampanhasAtivacaoComDataReferencia(ApiTester $i)
    {
        if (empty($this->dataReferenciaTeste)) {
