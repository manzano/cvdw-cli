...
class UnidadesCest extends Common
{
    public function getUnidades(ApiTester $i)
    {
        sleep(3);
        $startTime = time();
        ...
        $i->sendGet('/unidades', $bodyContent);
        sleep(3);
        $endTime = time();
    ...
    public function getUnidadesComDataReferencia(ApiTester $i)
    {
