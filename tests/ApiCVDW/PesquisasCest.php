...
class PesquisasCest extends Common
{
    ...
    public function getPesquisas(ApiTester $i)
    {
        ...
        $i->sendGet('/pesquisas', $getContent);
    ...
    public function getPesquisasComDataReferencia(ApiTester $i)
    {
        if (empty($this->dataReferenciaTeste)) {
