...
class PesquisasRespostasCest extends Common
{
    public function getPesquisasRespostas(ApiTester $i)
    {
        sleep(3);
        $startTime = time();
        ...
        $i->sendGet('/pesquisas/respostas', $bodyContent);
        sleep(3);
        $endTime = time();
    ...
    public function getPesquisasRespostasComDataReferencia(ApiTester $i)
    {
